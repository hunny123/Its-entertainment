    ...
    for(var i=0 ; i<b.items.length;i++){
     ...
     <iframe class="iframe-size " src="https://www.youtube.com/embed/${b.items[i].id.videoId}",frameborder='0'  onplay ="rty()" allowFullScreen width="100%" height="300px"></div></div>`)
        $("#c3 .carousel-indicators").append(`<li data-target="#c3" data-slide-to=${i} class=${k}></li>`)
    }


$("#c3").on('slide.bs.carousel',function(){
 console.log($('#c3 iframe').contents().find('video'))
