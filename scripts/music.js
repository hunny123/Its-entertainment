...
$(document).ready(function(){
 ...
 $.getJSON("https://www.googleapis.com/youtube/v3/playlistItems?playlistId=PLvFYFNbi-IBFeP5ALr50hoOmKiYRMvzUq&part=snippet&maxResults=10&key=AIzaSyCMlR6u_1n1nvEXH7rw6BpLhS_Rb7Agv8k", function(b) {
      
    for(var i=0 ; i<9;i++){
      
      console.log(b.items[i].snippet.title)
      $("#trending-music").append(`<div class="col-md-4 mt-2">
    <div class="card pb-3 " style="width:100%;height:100%">
   ...
   <a href='http://api.youtube6download.top/fetch/link.php?i=${b.items[i].snippet.resourceId.videoId}' class="btn  pt-3 ml-2 download-buttons" target="blank"><i class="fa fa-download pr-1"></i> Download Mp3</a>
    <a href="https://lolyoutube.com/download/mp4/${b.items[i].snippet.resourceId.videoId}"class="btn pt-3 ml-2 download-buttons" target="blank"><i class="fa fa-download  pr-1"></i> Download Mp4</a></center></div></div> </div>`)
 ...
 if(t===""){
  ...
  $.getJSON("https://www.googleapis.com/youtube/v3/search?q="+t+"&maxResults=4&type=video&key=AIzaSyCMlR6u_1n1nvEXH7rw6BpLhS_Rb7Agv8k&part=snippet", function(b) {
   ...
   <a href='http://api.youtube6download.top/fetch/link.php?i=${b.items[i].id.videoId}' class="btn  pt-3 ml-2 download-buttons" target="blank"><i class="fa fa-download pr-1"></i> Download Mp3</a>
    <a href="https://lolyoutube.com/download/mp4/${b.items[i].id.videoId}"class="btn pt-3 ml-2 download-buttons" target="blank"><i class="fa fa-download  pr-1"></i> Download Mp4</a></center></div></div> </div> `)
